...
BASE_ROW_LABEL_FONT_SIZE = 28
MIN_ROW_LABEL_FONT_SIZE = 18
...
class RowMemoryLayoutGif(Scene):
    def construct(self):
        n_cols = len(HEADERS)
        n_rows = len(ROWS)
        ...
        row_label_font_size = max(
            MIN_ROW_LABEL_FONT_SIZE,
            round(BASE_ROW_LABEL_FONT_SIZE * label_scale),
        )
